                    ...
                    <tbody>
                        <?php foreach ($trainers as $trainer): ?>
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="../Controllers/AdminController.php?page=deleteTrainer" style="display:inline;" onsubmit="return confirmDelete()">
        ...
        <div class="modal-content">
            <form method="POST" action="../Controllers/AdminController.php?page=updateTrainer">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Status</label>
                        <input type="text" class="form-control" id="edit_state" name="state" readonly>
                    </div>
                </div>
