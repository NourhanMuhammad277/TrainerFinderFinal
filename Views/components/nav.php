  <nav class="navbar navbar-expand-lg navbar-dark bg-success">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav ml-auto">
              <li class="nav-item">
                  <a class="nav-link" href="/TrainerFinderFinal/index.php">Home</a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                      <a class="dropdown-item" href="/TrainerFinderFinal/Views/myProfile.php">View Profile</a>
                      <div class="dropdown-divider"></div>
                      <a class="dropdown-item" href="/TrainerFinderFinal/Views/logout.php">Log Out</a>
                      <div class="dropdown-divider"></div>
